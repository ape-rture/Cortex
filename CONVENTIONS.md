...
- **Model routing**: See `context/model-routing.md`
...
| `src/core/` | Either (via branch) | Core runtime — coordinate carefully |
| `src/integrations/` | Either (via branch) | Integration modules — claim in active.md |
