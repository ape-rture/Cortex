...
| Agent | Role | Instruction File | Branch Prefix |
|---|---|---|---|
| **Claude Code** | Architect, system design, research, complex reasoning, documentation | `CLAUDE.md` | `claude/` |
| **OpenAI Codex** | Implementation specialist, feature building, testing, integrations | `AGENTS.md` | `codex/` |
