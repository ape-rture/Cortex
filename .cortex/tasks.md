...
- **Ralph Loop (Phase 10) - Codex core tasks** -- Agent: codex -- Branch: `codex/ralph-loop`. In progress: implement `codex-process`, enhanced board parser, `ralph-loop`, and orchestrator `execution_type` extension.
## Done
